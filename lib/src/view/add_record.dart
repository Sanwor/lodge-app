...
class _AddRecordState extends State<AddRecord> {
  ...
  final TextEditingController roomNoCon = TextEditingController();
                ...
                CustomButton(
                  ...
                  onTap: () async{
                    ...
                    final model = GuestRecordModel(
                      ...
                      roomNo: roomNoCon.text.trim(),
                      checkoutDate: widget.isUpdate == true ? checkoutDateCon.text.trim() : null,
                      checkoutTime: widget.isUpdate == true ? checkoutTimeCon.text.trim() : null,
                    );
